...
function get_theme () {
  ...
  *{
  ...
  .main_wrapper .timeline_wrapper.hide {
    display: none;
  }
  .main_wrapper .timeline_wrapper .card_group {
    width: 100%;
    display: grid;
    gap: 20px;
  ...
  .main_wrapper .timeline_wrapper .card_group > .active{
    outline: 4px solid var(--ac-1);
  }
  .main_wrapper .timeline_wrapper .card_group > .hide{
    display: none;
  }
  .main_wrapper .timeline_wrapper::-webkit-scrollbar {
    display: none;
  }
  .main_wrapper .timeline_wrapper .separator{
  ...
  .main_wrapper .current_separator{
    position: absolute;
    display: block;
    top: 0;
    width: calc(100% - 39px);
  ...
  .main_wrapper .scrollbar_wrapper{
    display: flex;
  }
  @container(min-width: 400px) {
    .main_wrapper .timeline_wrapper .card_group:last-child,
    .main_wrapper .timeline_wrapper .separator:last-child{
      margin-bottom: 300px;
    }
  }
